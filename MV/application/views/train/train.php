...
<div align="center">
	...
	<table border="0" width="1100" cellspacing="0" cellpadding="0" id="table474" bgcolor="#FFFFFF" height="40">
		...
		<tr>
			...
			当前位置： <a href="/">网站首页</a> > <a href="<?=APP_URL?>index/index">培训信息</a></td>
...
<table border="0" width="100%" cellspacing="0" class="leftmenu">
  ...
  <tr> 
		...
		<td class="" height="40"><a href="index.php?m=content&c=index&a=lists&catid=131"  class="" target="_self" >

		<p  style="margin-left:10px;&gt;&lt;a href=; text-align:left" target="_self" >

		<span style="font-size: 11pt">最新资讯</span></a></td>
  ...
  <tr> 
		...
		<td class="" height="40"><a href="index.php?m=content&c=index&a=lists&catid=109"  class="" target="_self" >

		<p  style="margin-left:10px;&gt;&lt;a href=; text-align:left" target="_self" >

		<span style="font-size: 11pt">新闻动态</span></a></td>
  ...
  <tr> 
		...
		<td class="" height="40"><a href="index.php?m=content&c=index&a=lists&catid=73"  class="" target="_self" >

		<p  style="margin-left:10px;&gt;&lt;a href=; text-align:left" target="_self" >

		<span style="font-size: 11pt">培训信息</span></a></td>
...
.qqlist span{ line-height:25px; padding-top:3px; display:block}
 ...
 <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
    ...
    <TD align="left" vAlign=top class="qqlist"><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=414161639&site=qq&menu=yes"><img border="0" src="<?=PUB_PATH?>images/index.gif" alt="<span>王老师</span>" title="点击这里给我发消息"><span>王老师</span></a><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=648013298&site=qq&menu=yes"><img border="0" src="<?=PUB_PATH?>images/index.gif" alt="<span>张老师</span>" title="点击这里给我发消息"><span>张老师</span></a></TD>
...
<tr> 
	<td align="left" id="<?=$v['art_id']?>" class="look" height="35">
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				<td>&nbsp; · <a hre="<?=APP_URL?>train/train_info&art_id=<?=$v['art_id']?>" target="_self"><?=$v['art_title']?></a></td>
				<td width="160"><?=$v['addtime']?></td>
			</tr>
		</table>
	</td>
</tr>
...
$(function() {
	...
	$('.look').click(function() {
		...
		$.ajax({
			url:'<?=APP_URL?>train/look',
			type:'post',
			data:{'art_id':id},
			success:function(obj) {
				if(obj == 1) {
					window.location.href="<?=APP_URL?>train/train_info&art_id="+id;
				}
			}
		})
	})
...
<table width="98%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr align="right"> 
      ...
      <td class="pages"><a class="a1">68条</a> <a href="http://www.bjxzpx.com/index.php?m=content&c=index&a=lists&catid=71&page=0" class="a1">上一页</a> <span>1</span> <a href="http://www.bjxzpx.com/index.php?m=content&c=index&a=lists&catid=71&page=2">2</a> <a href="http://www.bjxzpx.com/index.php?m=content&c=index&a=lists&catid=71&page=3">3</a> <a href="http://www.bjxzpx.com/index.php?m=content&c=index&a=lists&catid=71&page=4">4</a> <a href="http://www.bjxzpx.com/index.php?m=content&c=index&a=lists&catid=71&page=5">5</a> <a href="http://www.bjxzpx.com/index.php?m=content&c=index&a=lists&catid=71&page=2" class="a1">下一页</a></td>
