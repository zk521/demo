<div align="center">
	...
	<table border="0" width="1100" cellspacing="0" cellpadding="0" id="table474" bgcolor="#FFFFFF" height="40">
		<tr>
			<td>
			当前位置： <a href="/">网站首页</a> > <a href="<?php echo APP_URL ?>Course/index/2"><?=$title?></a></td>
		</tr>
	</table>
  </div>
</div>
...
<table width="1100" border="0" cellpadding="0" cellspacing="0" background="<?=PUB_PATH?>/images/centerbg.gif" style="border-top-width: 0px; border-bottom-width: 0px; " id="table556">
...
<td height=8></td></tr></tbody></table>
	...
	<table height=119 cellspacing=0 cellpadding=0 width=100% background=<?=PUB_PATH?>images/lianxiwomen.jpg border=0 id="table562" style="border-width: 0px">
...
.qqlist span{ line-height:25px; padding-top:3px; display:block}
 ...
 <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
    ...
    <TD align="left" vAlign=top class="qqlist"><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=414161639&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:648013298:7" alt="<span>王老师</span>" title="点击这里给我发消息"><span>王老师</span></a><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=648013298&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:648013298:7" alt="<span>张老师</span>" title="点击这里给我发消息"><span>张老师</span></a></TD>
	...
	<td valign="top" style="border:1px solid #E6E6E6; ">
      ...
      <table height=500 cellspacing=20 cellpadding=0 width="100%" border=0 id="table565">
        ...
        <?php foreach ($items as $key => $value): ?>
			    <tr> 
					<td align="left" class="cellcolor" height="35">
					<table border="0" width="100%" cellspacing="0" cellpadding="0">
						<tr>
							<td>&nbsp; · <a href="<?php echo APP_URL ?>Course/content/<?=$title?>/<?=$value['art_id']?>" target="_self"><?=$value['art_title']?></a></td>
							<td width="80"><?=$value['addtime']?></td>
						</tr>
					</table>
					</td>
			    </tr>
        <?php endforeach ?>
			...
			<table width="98%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr align="right"> 
			      ...
			      <td class="pages"><a class="a1"><?=$num?>条</a> <a href="http://www.bjxzpx.com/index.php?m=content&c=index&a=lists&catid=128&page=0" class="a1">上一页</a> <span>1</span><a href="http://www.bjxzpx.com/index.php?m=content&c=index&a=lists&catid=128&page=1" class="a1">下一页</a></td>
