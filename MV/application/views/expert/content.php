...
.qqlist span{ line-height:25px; padding-top:3px; display:block}
 ...
 <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
    ...
    <TD align="left" vAlign=top class="qqlist"><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=414161639&site=qq&menu=yes"><img border="0" src="<?php echo PUB_PATH?>images/index.gif" alt="<span>王老师</span>" title="点击这里给我发消息"><span>王老师</span></a><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=648013298&site=qq&menu=yes"><img border="0" src="<?php echo PUB_PATH?>images/index.gif" alt="<span>张老师</span>" title="点击这里给我发消息"><span>张老师</span></a></TD>
        ...
        <tbody>
          ...
          <tr valign=top>
            ...
            <p style="text-indent:2em;">
               <h3 style="text-align: center"><?=$teachers['t_name']?></h3>
               <center><span> <img src="<?php echo PUB_PATH?><?=$teachers['t_image']?>" width="180" height="230" alt="牟老师" border="0" /></span></center>
	<span style="font-size:14px;"></span><span style="font-size:14px;"><?=$teachers['t_introduce']?></span>
